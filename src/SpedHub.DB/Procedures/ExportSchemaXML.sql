CREATE PROCEDURE [ExportSchemaXml]
AS
SELECT 
        ...
        SELECT	
            ...
            [WhereExp] = i.filter_definition,
             ...
             --members
                 ...
                 SELECT	
                         [Column] =c.name, 
                         [Position] = CASE WHEN ic.key_ordinal=0 THEN NULL ELSE ic.key_ordinal END,
                         ...
                         ORDER BY o.name, i.name, CASE WHEN ic.key_ordinal=0 THEN 999 ELSE ic.key_ordinal END
